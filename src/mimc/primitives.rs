...
use crate::mimc::round_constants::{MIMC_HASH_PALLAS_ROUND_CONSTANTS, MIMC_HASH_VESTA_ROUND_CONSTANTS};
...
pub fn mimc5_hash_pallas(
    ...
    mimc5_hash::<Fp, NUM_ROUNDS>(state, MIMC_HASH_PALLAS_ROUND_CONSTANTS);
}

pub fn mimc5_hash_vesta(
    state: &mut Fq,
) {
    mimc5_hash::<Fq, NUM_ROUNDS>(state, MIMC_HASH_VESTA_ROUND_CONSTANTS);
}
...
pub fn mimc5_encrypt_pallas(
    ...
    mimc5_encrypt::<Fp, NUM_ROUNDS>(state, key, MIMC_HASH_PALLAS_ROUND_CONSTANTS);
}
...
pub fn mimc5_encrypt_vesta(
    ...
    mimc5_encrypt::<Fq, NUM_ROUNDS>(state, key, MIMC_HASH_VESTA_ROUND_CONSTANTS);
}